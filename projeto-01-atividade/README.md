...
- [Melhorias do Template Original](#melhorias-do-template-original)
...
Este projeto estende o template original da pós-graduação UniPDS com cópia situada em: [templates/projeto-01-template](https://github.com/falkondev/posgrad-1-fundamentos-ia-llm/tree/main/templates/projeto-01-template). As extensões abrangem:
...
2. **Configure as Variáveis de Ambiente com o .env**
   ```bash
...
- Idade do usuário (ex. 20-80 anos → 0-1)
- Preço do produto (ex. 10-1000 → 0-1)
